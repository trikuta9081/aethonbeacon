...
assert(source.includes('buildJourneySteps(mergedThemes, issueId, route, moonChart48Readings, { streak, moodTagLeaning })'), 'Counselling journey is not using Moon Chart 48D readings');
